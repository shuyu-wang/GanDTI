...
dudeDir = './DUDE/' 
kikdDir = './kikd/' 
#celegansDir = './data_celegans/'  
humanData = 'data_human.txt'
dudeData = 'DUDE-foldTrain3.txt'
IC50Data = 'IC50_data.txt'
kikdData = 'bindingDB_ki_10000.txt'
#celegansData = 'data.txt'
...
np.save(Dir + 'compounds', compounds)
np.save(Dir + 'adjacencies', adjacencies)
np.save(Dir + 'proteins', proteins)
np.save(Dir + 'interactions', interactions)

with open(Dir + 'fingerprint.pickle', 'wb') as f:
    pickle.dump(dict(fingerprintDict), f)

with open(Dir + 'wordDict.pickle', 'wb') as f:
